...
enum ActionKind: String, CaseIterable {
    ...
    case setQueueStatus = "Set Queue Status"
    case setTopicStatus = "Set Topic Status"
    ...
    var systemImage: String {
        ...
        case .setQueueStatus: return "tray.circle"
        case .setTopicStatus: return "bubble.left.and.bubble.right.circle"
