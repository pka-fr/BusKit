...
internal enum Buskit_BusKitService: Sendable {
    ...
    internal enum Method: Sendable {
        ...
        /// Namespace for "SetQueueStatus" metadata.
        internal enum SetQueueStatus: Sendable {
            /// Request type for "SetQueueStatus".
            internal typealias Input = Buskit_SetQueueStatusRequest
            /// Response type for "SetQueueStatus".
            internal typealias Output = Buskit_SetQueueStatusReply
            /// Descriptor for "SetQueueStatus".
            internal static let descriptor = GRPCCore.MethodDescriptor(
                service: GRPCCore.ServiceDescriptor(fullyQualifiedService: "buskit.BusKitService"),
        ...
        internal enum CreateSubscription: Sendable {
            /// Request type for "CreateSubscription".
            internal typealias Input = Buskit_CreateSubscriptionRequest
            /// Response type for "CreateSubscription".
            internal typealias Output = Buskit_CreateSubscriptionReply
        ...
        /// Namespace for "GetTopicMetrics" metadata.
        internal enum GetTopicMetrics: Sendable {
            internal typealias Input = Buskit_GetTopicMetricsRequest
            internal typealias Output = Buskit_GetTopicMetricsReply
            internal static let descriptor = GRPCCore.MethodDescriptor(
                service: GRPCCore.ServiceDescriptor(fullyQualifiedService: "buskit.BusKitService"),
...
extension Buskit_BusKitService {
    ...
    internal protocol ClientProtocol: Sendable {
        ...
        /// Call the "SetQueueStatus" method.
        ///
        /// - Parameters:
        ///   - request: A request containing a single `Buskit_SetQueueStatusRequest` message.
        ///   - serializer: A serializer for `Buskit_SetQueueStatusRequest` messages.
        ///   - deserializer: A deserializer for `Buskit_SetQueueStatusReply` messages.
        ///   - options: Options to apply to this RPC.
        ///   - handleResponse: A closure which handles the response, the result of which is
        ///       returned to the caller. Returning from the closure will cancel the RPC if it
        ///       hasn't already finished.
        /// - Returns: The result of `handleResponse`.
        func setQueueStatus<Result>(
            request: GRPCCore.ClientRequest<Buskit_SetQueueStatusRequest>,
            serializer: some GRPCCore.MessageSerializer<Buskit_SetQueueStatusRequest>,
        ...
        ///
        /// - Parameters:
        ///   - request: A request containing a single `Buskit_CreateSubscriptionRequest` message.
        ///   - serializer: A serializer for `Buskit_CreateSubscriptionRequest` messages.
        ///   - deserializer: A deserializer for `Buskit_CreateSubscriptionReply` messages.
        ///   - options: Options to apply to this RPC.
        ///   - handleResponse: A closure which handles the response, the result of which is
        ///       returned to the caller. Returning from the closure will cancel the RPC if it
        ///       hasn't already finished.
        ...
        func createSubscription<Result>(
            request: GRPCCore.ClientRequest<Buskit_CreateSubscriptionRequest>,
            serializer: some GRPCCore.MessageSerializer<Buskit_CreateSubscriptionRequest>,
        ...
        /// Call the "GetTopicMetrics" method.
        func getTopicMetrics<Result>(
            request: GRPCCore.ClientRequest<Buskit_GetTopicMetricsRequest>,
            serializer: some GRPCCore.MessageSerializer<Buskit_GetTopicMetricsRequest>,
    ...
    internal struct Client<Transport>: ClientProtocol where Transport: GRPCCore.ClientTransport {
        ...
        ///       hasn't already finished.
        /// - Returns: The result of `handleResponse`.
        internal func setQueueStatus<Result>(
            request: GRPCCore.ClientRequest<Buskit_SetQueueStatusRequest>,
            serializer: some GRPCCore.MessageSerializer<Buskit_SetQueueStatusRequest>,
            deserializer: some GRPCCore.MessageDeserializer<Buskit_SetQueueStatusReply>,
            options: GRPCCore.CallOptions = .defaults,
            onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Buskit_SetQueueStatusReply>) async throws -> Result = { response in
                try response.message
            }
        ) async throws -> Result where Result: Sendable {
            try await self.client.unary(
        ...
        internal func createSubscription<Result>(
            ...
            deserializer: some GRPCCore.MessageDeserializer<Buskit_CreateSubscriptionReply>,
            options: GRPCCore.CallOptions = .defaults,
            onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Buskit_CreateSubscriptionReply>) async throws -> Result = { response in
                try response.message
            }
        ) async throws -> Result where Result: Sendable {
            try await self.client.unary(
                request: request,
                descriptor: Buskit_BusKitService.Method.CreateSubscription.descriptor,
                serializer: serializer,
                deserializer: deserializer,
                options: options,
                onResponse: handleResponse
        ...
        internal func getTopicMetrics<Result>(
            request: GRPCCore.ClientRequest<Buskit_GetTopicMetricsRequest>,
            serializer: some GRPCCore.MessageSerializer<Buskit_GetTopicMetricsRequest>,
            deserializer: some GRPCCore.MessageDeserializer<Buskit_GetTopicMetricsReply>,
            options: GRPCCore.CallOptions = .defaults,
            onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Buskit_GetTopicMetricsReply>) async throws -> Result = { response in
                try response.message
            }
        ) async throws -> Result where Result: Sendable {
            try await self.client.unary(
                request: request,
                descriptor: Buskit_BusKitService.Method.GetTopicMetrics.descriptor,
                serializer: serializer,
                deserializer: deserializer,
                options: options,
                onResponse: handleResponse
...
extension Buskit_BusKitService.ClientProtocol {
    ...
    internal func setQueueStatus<Result>(
        ...
        try await self.setQueueStatus(
            request: request,
            serializer: GRPCProtobuf.ProtobufSerializer<Buskit_SetQueueStatusRequest>(),
            deserializer: GRPCProtobuf.ProtobufDeserializer<Buskit_SetQueueStatusReply>(),
            options: options,
            onResponse: handleResponse
        )
    }
    ...
    internal func getTopicMetrics<Result>(
        ...
        try await self.getTopicMetrics(
            request: request,
...
extension Buskit_BusKitService.ClientProtocol {
    ...
    /// - Returns: The result of `handleResponse`.
    internal func setQueueStatus<Result>(
        _ message: Buskit_SetQueueStatusRequest,
        metadata: GRPCCore.Metadata = [:],
        options: GRPCCore.CallOptions = .defaults,
        onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Buskit_SetQueueStatusReply>) async throws -> Result = { response in
            try response.message
        ...
        let request = GRPCCore.ClientRequest<Buskit_SetQueueStatusRequest>(
            message: message,
            metadata: metadata
        )
    ...
    /// - Returns: The result of `handleResponse`.
    internal func createSubscription<Result>(
        _ message: Buskit_CreateSubscriptionRequest,
        metadata: GRPCCore.Metadata = [:],
        options: GRPCCore.CallOptions = .defaults,
        onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Buskit_CreateSubscriptionReply>) async throws -> Result = { response in
            try response.message
        ...
        let request = GRPCCore.ClientRequest<Buskit_CreateSubscriptionRequest>(
            message: message,
            metadata: metadata
        )
    ...
    internal func getTopicMetrics<Result>(
        _ message: Buskit_GetTopicMetricsRequest,
        metadata: GRPCCore.Metadata = [:],
        options: GRPCCore.CallOptions = .defaults,
        onResponse handleResponse: @Sendable @escaping (GRPCCore.ClientResponse<Buskit_GetTopicMetricsReply>) async throws -> Result = { response in
            try response.message
        ...
        let request = GRPCCore.ClientRequest<Buskit_GetTopicMetricsRequest>(
            message: message,
            metadata: metadata
        )
